...
//        em.flush(); // 벌크연산은 영속성컨텍스트 안 거치고 DB에 직접 넣는거라 영속성컨텍스트를 한 번 업데이트 해 줘야 반영됨
//        em.clear(); // 플러시 후에 클리어 해주기 (초기화) or 이거 안 하고 리포지토리 Modify 옵션을 설정해주면됨
